...
const AccountStateSchema = z.object({
  ...
  walletLpPositions: z.array(z.object({
    ...
    fundedBinCount: z.number().int().optional(),
	    ...
	    lpSolExposureStatus: z.enum(['sol-heavy', 'mixed', 'token-heavy', 'sol-depleted']).optional(),
    ...
    unclaimedFeeSolAmount: z.number().finite().nonnegative().optional(),
    unclaimedFeeTokenAmountLamports: z.number().finite().nonnegative().optional(),
    unclaimedFeeTokenAmountRaw: z.string().regex(/^\d+$/).optional(),
    unclaimedFeeTokenMint: z.string().optional(),
    unclaimedFeeTokenValueSol: z.number().finite().nonnegative().optional(),
    unclaimedFeeSol: z.number().finite().nonnegative().optional(),
    unclaimedFeeValueSol: z.number().finite().nonnegative().optional(),
    claimedFeeValueSol: z.number().finite().nonnegative().optional(),
    recoverableRentSol: z.number().finite().nonnegative().optional(),
