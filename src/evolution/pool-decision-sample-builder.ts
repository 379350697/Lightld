    ...
    return scan.candidates.map((candidate) => {
      ...
      return {
        ...
        candidateFeatures: {
          ...
          auxSignalScore: candidate.auxSignalScore,
          dexscreenerBoostAmount: candidate.dexscreenerBoostAmount,
          dexscreenerHasProfile: candidate.dexscreenerHasProfile,
          jupiterOrganicScore: candidate.jupiterOrganicScore,
          jupiterTrendingRank: candidate.jupiterTrendingRank,
          coingeckoTrendingRank: candidate.coingeckoTrendingRank,
          auxSignalStatus: candidate.auxSignalStatus,
